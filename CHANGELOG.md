...
### Added
- 🎉 Initial release of AI Invoice Generator
- 🤖 AI-powered invoice parsing using OpenAI GPT models
...
- **Legacy**: 0.8.0 and below (No support)

### Upgrade Path
- 0.8.0 → 0.9.0: Minor updates required
